...
public class MultiThreadedClientExample extends Configured implements Tool {
    ...
    public MultiThreadedClientExample(int threads,List<byte[]> rowkeys) throws IOException {
...
//            value_size = Long.valueOf(args[1]);
...
//            double r = ThreadLocalRandom.current().nextDouble();
            ...
            f = internalPool.submit(new WriteExampleCallable(writeConnection, tableName,value_size,rows,cf,c,wal,rowkeys,rak));
...
//                        System.out.println(("foo"+j)+("c"+k));
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (byte[] a: rowkeys){
            if (a == null) {
                System.out.println("Hbase Random Batch Scanner ERROR");
                System.exit(1);
            }
        }
